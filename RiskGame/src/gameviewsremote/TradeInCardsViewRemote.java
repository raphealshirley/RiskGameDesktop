...
public class TradeInCardsViewRemote extends JFrame {
    ...
    public TradeInCardsViewRemote(){
        ...
        this.add(Label1);
        Label1.setFont(new Font("dialog",4,15));

        Label2 = new JLabel("");
        Label2.setForeground(Color.RED);
        Label2.setBounds(15,45,470,60);
        this.add(Label2);
        Label2.setFont(new Font("dialog",4,15));
        
        Label3 = new JLabel("");
        Label3.setForeground(Color.BLUE);
        Label3.setBounds(15,105,470,20);
        this.add(Label3);
        Label3.setFont(new Font("dialog",4,15));
	 ...
	 * @param info1 String info 1
	 * @param info2 String info 2
	 * @param info3 String info 3
	 * @param info4 String info 4 
